...
struct _game
{
   ...
   * different cards, the array will have 400 elements. One
   * element will contain a pointer to the card, and the next
   * element keeps count of the number of this card is in the game.
   */
